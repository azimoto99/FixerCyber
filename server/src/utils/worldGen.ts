...
export class WorldGenerator {
  ...
  private static getNPCBehavior(districtType: string): string {
    ...
    const behaviorList = behaviors[districtType as keyof typeof behaviors] || ['idle']
  ...
  private static getLootRarity(districtType: string): string {
    ...
    const weightList = weights[districtType as keyof typeof weights] || [0.5, 0.3, 0.15, 0.04, 0.01]
