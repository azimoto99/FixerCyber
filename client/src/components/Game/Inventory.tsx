    ...
    <div className="w-full h-full bg-cyberpunk-dark/95 backdrop-blur-sm flex items-center justify-center">
      <div className="bg-cyberpunk-gray border border-cyberpunk-primary rounded-lg p-6 w-full max-w-4xl h-5/6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-cyberpunk-primary">INVENTORY</h2>
          <button
            onClick={onClose}
        ...
        {/* Item Details */}
        <div className="mt-6">
          <h3 className="text-lg font-bold text-cyberpunk-primary mb-4">ITEMS</h3>
          <div className="space-y-2">
            {inventory.length === 0 ? (
              ...
              inventory.map((item) => (
                ...
                >
                  <div>
                    <div className="font-bold text-cyberpunk-primary">{item.name}</div>
                    <div className="text-sm text-cyberpunk-light">{item.type}</div>
                  </div>
