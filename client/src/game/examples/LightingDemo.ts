...
export class LightingDemo {
  ...
  private setupDemo(): void {
    ...
    const districts = [
      { type: DistrictType.CORPORATE, bounds: { x: -200, y: -200, width: 200, height: 200 } },
      { type: DistrictType.INDUSTRIAL, bounds: { x: 0, y: -200, width: 200, height: 200 } },
      { type: DistrictType.RESIDENTIAL, bounds: { x: -200, y: 0, width: 200, height: 200 } },
      { type: DistrictType.UNDERGROUND, bounds: { x: 0, y: 0, width: 200, height: 200 } },
      { type: DistrictType.WASTELAND, bounds: { x: 200, y: 200, width: 200, height: 200 } }
    ];

    districts.forEach(district => {
      this.lightingSystem.generateDistrictLighting(district.type, district.bounds);
    });
  ...
  private addDemoSprites(): void {
    ...
    const buildings = [
      { pos: new Vector2(-100, -100), color: '#333333', size: new Vector2(40, 60) },
      { pos: new Vector2(50, -150), color: '#444444', size: new Vector2(30, 80) },
      { pos: new Vector2(-150, 50), color: '#555555', size: new Vector2(50, 40) },
      { pos: new Vector2(100, 100), color: '#222222', size: new Vector2(35, 70) }
    ];
