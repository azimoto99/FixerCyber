...
export class AudioManager {
  ...
  playShootSound(weaponType: string): void {
    ...
    const soundName =
      sounds[weaponType as keyof typeof sounds] || 'shoot_pistol';
  ...
  playHitSound(damageType: string): void {
    ...
    const soundName =
      sounds[damageType as keyof typeof sounds] || 'hit_kinetic';
    this.playSound(soundName);
  }
  ...
  playAmbientSound(environment: string): void {
    ...
    const soundName =
      sounds[environment as keyof typeof sounds] || 'ambient_corporate';
